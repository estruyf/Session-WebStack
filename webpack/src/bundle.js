...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(page_1.default, null), document.getElementById("root"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tweets_1 = __webpack_require__(6);
	...
	var Page = (function (_super) {
	    ...
	    Page.prototype.render = function () {
	        ...
	        return (React.createElement("div", {className: "ms-Grid"}, 
	            React.createElement(header_1.default, {names: names}), 
	            React.createElement(tweets_1.default, null)));
	    };
	    return Page;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = (function (_super) {
	    ...
	    Header.prototype.render = function () {
	        return (React.createElement("h1", {className: "ms-font-xl"}, 
	            "Show tweets about: ", 
	            this.props.names.map(function (name, index) {
	                return (React.createElement("b", {key: index}, name));
	            })));
	    };
	    return Header;
	}(React.Component));
	    ...
	    Tweets.prototype.render = function () {
	        if (typeof this.state.tweets !== 'undefined' && this.state.tweets !== null) {
	            return (React.createElement("div", null, 
	                React.createElement("h2", {className: "ms-font-l"}, 
	                    "Number of tweets: ", 
	                    React.createElement("span", null, this.state.tweets.length)), 
	                React.createElement("ul", null, this.state.tweets.map(function (tweet, index) {
	                    return (React.createElement("li", {className: "ms-font-m", key: index}, 
	                        "[", 
	                        moment(tweet.created_at).format('DD/MM/YY HH:mm:ss'), 
	                        "]: ", 
	                        tweet.text, 
	                        " - ", 
